...
export default function ListeningTest({ onFinish, voiceURI, questionCount, verbFilter, verbStats, explanationTime, correctExplanationTime, onRemoveWeak }: ListeningTestProps) {
    ...
    <div className="max-w-md mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 text-center mb-6 relative overflow-hidden">
        ...
        <div className="relative z-20">
          <button
            onClick={() => playSound(currentVerb[targetForm])}
            disabled={isPlaying || feedback !== null}
            className={`w-16 h-16 mx-auto rounded-full flex items-center justify-center transition-colors mb-8 ${
              isPlaying ? 'bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400' : 'bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-900 dark:text-gray-100'
            }`}
          >
            <Volume2 size={24} />
          </button>
